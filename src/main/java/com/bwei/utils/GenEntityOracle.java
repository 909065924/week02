...
public class GenEntityOracle {
    ...
    private String packageOutPath = "com.bwei.beans";// ~~~~~~~~~~~~~~~~~~~~~~~~~ָ��ʵ���������ڰ���·��
...
//    private static final String PASS = "tiger";
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    private static final String URL="jdbc:mysql://localhost:3306/week1?user=root&password=root&useUnicode=true&characterEncoding=UTF8";
...
//            return "Date";
    ...
    public static void main(String[] args) {  
        ...
        //�������Ǳ���  ���ɵ�ʵ������ĸ��д   ������User
    	//��һ������ ���ݿ����    �ڶ�������ʵ������    �������������ݿ�����
        new GenEntityOracle("brand","Brand","week1").init();  
        new GenEntityOracle("goods","Goods","week1").init();
        new GenEntityOracle("goodskind","GoodsKind","week1").init();
